...
class Major(models.Model):
    id = models.AutoField('序号', primary_key=True)
    academy = models.ForeignKey(Academy, on_delete=models.CASCADE, verbose_name='学院',null=True)
...
class Student(models.Model):
    ...
    sex = models.CharField('性别', max_length=1, choices=(('F', '女'), ('M', '男')))
...
class Teacher(models.Model):
    sid = models.CharField('教师编号', max_length=12, primary_key=True)
    name = models.CharField('姓名', max_length=20, unique=True)
    sex = models.CharField('性别', max_length=1, choices=(('F', '女'), ('M', '男')))
    age = models.IntegerField('年龄')
    academy = models.ForeignKey(Academy, on_delete=models.CASCADE, verbose_name='学院',null=True)
...
class CourseManager(models.Model):
    sid = models.CharField('编号', max_length=12, primary_key=True)
    name = models.CharField('姓名', max_length=20, unique=True)
    sex = models.CharField('性别', max_length=1, choices=(('F', '女'), ('M', '男')))
    age = models.IntegerField('年龄')
    pwd = models.CharField('密码', max_length=20)
